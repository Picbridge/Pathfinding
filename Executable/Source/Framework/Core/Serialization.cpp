...
bool Serialization::open_file(FILE ** file, const std::experimental::filesystem::path &filepath, bool readOnly)
{
...
bool Serialization::read_file(rj::Document &doc, const std::experimental::filesystem::path &filepath)
{
    FILE *file;
...
bool Serialization::write_file(rj::Document &doc, const std::experimental::filesystem::path &filepath)
{
    FILE *file;
